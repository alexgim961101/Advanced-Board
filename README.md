...
## 프로젝트 구조 소개
### 1). 프로젝트 구조
![스크린샷 2023-08-20 오후 8.32.02.png](%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7%202023-08-20%20%EC%98%A4%ED%9B%84%208.32.02.png)
### 2). 테이블 구조
![스크린샷 2023-08-20 오후 3.37.31.png](%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7%202023-08-20%20%EC%98%A4%ED%9B%84%203.37.31.png)
### 3). 로직 흐름
![스크린샷 2023-08-20 오후 10.49.02.png](%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7%202023-08-20%20%EC%98%A4%ED%9B%84%2010.49.02.png)
### 4). 초기 값
```sql
INSERT INTO board (title, created_at, updated_at) VALUES ('자유 게시판', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
```
- 게시판 생성 기능은 요구사항에 없었기 때문에 프로젝트 시작시 임의로 게시판을 생성
- 테스트 코드에서는 임의로 생성하지 않았음
## 구현 방법에 대한 소개
